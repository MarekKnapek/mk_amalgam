...
#undef mk_uint_small_concat_2
#undef mk_uint_small_concat_1
#undef mk_uint_small_concat
...
#undef mk_uint_small_from_buff_be
...
#undef mk_uint_small_gt
#undef mk_uint_small_ge
