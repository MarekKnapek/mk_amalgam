...
mk_extern_c mk_win_base_keywords_dll_import mk_win_base_kernel_types_farproc_t mk_win_base_keywords_calling_convention_api GetProcAdddress(mk_win_base_types_hinstance_t, mk_win_base_types_strac_t);
