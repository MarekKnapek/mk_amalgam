...
#define mk_win_user_message_peek_noremove ((unsigned short)(0x0000ul))
#define mk_win_user_message_peek_remove   ((unsigned short)(0x0001ul))
#define mk_win_user_message_peek_noyield  ((unsigned short)(0x0002ul))
