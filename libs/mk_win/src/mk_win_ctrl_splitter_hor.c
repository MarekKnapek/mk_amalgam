#include "mk_win_ctrl_splitter_hor.h"
...
struct mk_win_ctrl_splitter_hor_s
{
...
mk_win_base_types_make_struct(mk_win_ctrl_splitter_hor);


static mk_win_char_t const s_win_ctrl_splitter_hor_class_name[] = mk_win_char_c("mkwcsh");


mk_win_base_types_atom_t g_win_ctrl_splitter_hor_atom;


mk_jumbo int mk_win_ctrl_splitter_hor_reposition(mk_win_ctrl_splitter_hor_t* const self);
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_create(mk_win_base_user_types_hwnd_t const hwnd, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam);
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_destroy(mk_win_ctrl_splitter_hor_t* const self, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam);
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_size(mk_win_ctrl_splitter_hor_t* const self, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam);
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_notify(mk_win_ctrl_splitter_hor_t* const self, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam);
...
mk_jumbo mk_win_base_user_types_lresult_t mk_win_base_keywords_calling_convention_api mk_win_ctrl_splitter_hor_wndproc(mk_win_base_user_types_hwnd_t const hwnd, mk_win_base_types_uint_t const msg, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam);
...
mk_jumbo int mk_win_ctrl_splitter_hor_class_register(void)
{
	...
	mk_assert(!g_win_ctrl_splitter_hor_atom);

	cls.m_style = 0;
	cls.m_wndproc = &mk_win_ctrl_splitter_hor_wndproc;
	cls.m_cls_extra = 0;
	cls.m_wnd_extra = ((int)(sizeof(mk_win_ctrl_splitter_hor_lpt)));
	...
	mk_try(mk_win_user_class_register(&cls, &g_win_ctrl_splitter_hor_atom));
	mk_assert(g_win_ctrl_splitter_hor_atom);
...
mk_jumbo int mk_win_ctrl_splitter_hor_class_get_atom(mk_win_base_types_atom_t* const atom)
{
	...
	*atom = g_win_ctrl_splitter_hor_atom;
...
mk_jumbo int mk_win_ctrl_splitter_hor_class_get_name(mk_win_strc_t* const name)
{
	...
	*name = s_win_ctrl_splitter_hor_class_name;
...
mk_jumbo int mk_win_ctrl_splitter_hor_reposition(mk_win_ctrl_splitter_hor_t* const self)
{
	...
	if(self->m_child_left && self->m_child_right)
	{
		...
		middle = ((int)((((long)(width)) * ((long)(self->m_ratio))) / ((long)(10000))));
		if(middle < 10) middle = 10;
		if(middle > width - 10) middle = width - 10;
		mk_try(mk_win_user_window_move(self->m_child_left, 0, 0, middle - s_border / 2, height, 1, &b)); mk_assert(b != 0);
		mk_try(mk_win_user_window_move(self->m_child_right, middle + s_border / 2, 0, width - middle - s_border, height, 1, &b)); mk_assert(b != 0);
	}
...
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_create(mk_win_base_user_types_hwnd_t const hwnd, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam)
{
	mk_win_ctrl_splitter_hor_t* self;
	...
	self->m_sizing = 0;
	mk_try(mk_win_user_window_set_info(hwnd, 0, ((mk_win_base_types_uintptr_t)((mk_win_ctrl_splitter_hor_lpt)(self))), &prev)); mk_assert(prev == 0);
...
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_destroy(mk_win_ctrl_splitter_hor_t* const self, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam)
{
	...
	mk_assert(((mk_win_ctrl_splitter_hor_pt)((mk_win_ctrl_splitter_hor_lpt)(prev))) == self);
...
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_size(mk_win_ctrl_splitter_hor_t* const self, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam)
{
	...
	mk_try(mk_win_ctrl_splitter_hor_reposition(self));
...
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg_mousemove(mk_win_ctrl_splitter_hor_t* const self, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam)
{
	...
	{
		mk_try(mk_win_user_window_get_client_rect(self->m_hwnd, &rect, &b)); mk_assert(b != 0);
		x = ((int)(((short)(lparam & 0xfffful))));
		self->m_ratio = ((int)((((long)(x)) * ((long)(10000))) / ((long)(rect.m_right))));
		if(self->m_ratio < 500) self->m_ratio = 500;
		if(self->m_ratio > 9500) self->m_ratio = 9500;
		mk_win_ctrl_splitter_hor_reposition(self);
	}
...
mk_jumbo int mk_win_ctrl_splitter_hor_on_msg(mk_win_ctrl_splitter_hor_t* const self, mk_win_base_types_uint_t const msg, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam)
{
	...
	switch(msg)
	{
		case mk_win_user_window_wm_destroy: mk_try(mk_win_ctrl_splitter_hor_on_msg_destroy(self, wparam, lparam)); break;
		case mk_win_user_window_wm_size: mk_try(mk_win_ctrl_splitter_hor_on_msg_size(self, wparam, lparam)); break;
		case mk_win_user_window_wm_notify: mk_try(mk_win_ctrl_splitter_hor_on_msg_notify(self, wparam, lparam)); break;
...
mk_jumbo int mk_win_ctrl_splitter_hor_on_wndproc(mk_win_base_user_types_hwnd_t const hwnd, mk_win_base_types_uint_t const msg, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam, mk_win_base_user_types_lresult_t* const lr)
{
	...
	{
		mk_try(mk_win_ctrl_splitter_hor_on_msg_create(hwnd, wparam, lparam));
	}
	else
	{
		...
		if(info != 0)
		{
			self = ((mk_win_ctrl_splitter_hor_pt)((mk_win_ctrl_splitter_hor_lpt)(info))); mk_assert(self);
			mk_try(mk_win_ctrl_splitter_hor_on_msg(self, msg, wparam, lparam));
		}
	}
...
mk_jumbo mk_win_base_user_types_lresult_t mk_win_base_keywords_calling_convention_api mk_win_ctrl_splitter_hor_wndproc(mk_win_base_user_types_hwnd_t const hwnd, mk_win_base_types_uint_t const msg, mk_win_base_user_types_wparam_t const wparam, mk_win_base_user_types_lparam_t const lparam)
{
	...
	err = mk_win_ctrl_splitter_hor_on_wndproc(hwnd, msg, wparam, lparam, &lr);
	mk_assert(err == 0);
