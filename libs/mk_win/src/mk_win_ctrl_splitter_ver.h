#ifndef mk_include_guard_win_ctrl_splitter_ver
#define mk_include_guard_win_ctrl_splitter_ver
...
#define mk_win_ctrl_splitter_ver_wm_set_ratio ((unsigned short)(mk_win_user_window_wm_user + 0x0001ul))
#define mk_win_ctrl_splitter_ver_wm_set_child ((unsigned short)(mk_win_user_window_wm_user + 0x0002ul))
