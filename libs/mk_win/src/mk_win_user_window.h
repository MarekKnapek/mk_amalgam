...
#define mk_win_user_window_wm_mousemove       ((unsigned short)0x0200ul)
#define mk_win_user_window_wm_lbuttondown     ((unsigned short)0x0201ul)
#define mk_win_user_window_wm_lbuttonup       ((unsigned short)0x0202ul)
