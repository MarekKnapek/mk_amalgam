...
mk_lang_jumbo void mk_num_div_mod(mk_num_div_mod_small_type const* x, mk_num_div_mod_small_type const* y, mk_num_div_mod_small_type* res_div, mk_num_div_mod_small_type* res_mod)
{
	...
	if(leny == 1)
	{
		...
		mk_lang_assert(sizeof(mk_num_div_mod_mid_type) >= 2 * sizeof(mk_num_div_mod_small_type));
	...
	}
	{
		...
		for(id = 0; id != lenx - leny + 1; ++id)
		{
			...
			mk_num_div_mod_mid_type rn;
			mk_num_div_mod_small_type dn;
			#endif
			...
			#if(mk_num_div_mod_use_r1d2 == 0)
			mk_lang_assert(sizeof(mk_num_div_mod_big_type) >= 3 * sizeof(mk_num_div_mod_small_type));
			rn =
			...
			mk_lang_assert(((mk_num_div_mod_small_type)(((mk_num_div_mod_small_type)(xx[lenx - leny - id + i] - dq[i])) - borrow1)) == 0);
		}
		if(f == 1)
		{
			for(i = 0; i != leny; ++i)
		...
		else
		{
			...
			carry = ((mk_num_div_mod_small_type)(xx[leny - 1] - ((mk_num_div_mod_small_type)(m * f))));
			res_mod[(lenm - 1) - (lenm - leny)] = m;
			for(i = 1; i != leny - 1; ++i)
			{
				tmp = ((mk_num_div_mod_mid_type)(((mk_num_div_mod_mid_type)(((mk_num_div_mod_mid_type)(carry)) << (sizeof(mk_num_div_mod_small_type) * mk_lang_charbit))) | ((mk_num_div_mod_mid_type)(xx[leny - 1 - i]))));
				m = ((mk_num_div_mod_small_type)(tmp / f));
				carry = ((mk_num_div_mod_small_type)(xx[leny - 1 - i] - ((mk_num_div_mod_small_type)(m * f))));
